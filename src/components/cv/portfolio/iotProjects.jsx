    ...
    return (
        <div>
            ...
            <div className="web-card">
                ...
                <div>
                    <h3 style={{fontSize:"18px",fontWeight:"500",marginBottom:"5px"}}>Smart Parking Slot Monitoring System</h3>
                ...
                <div>
                <a href="https://wokwi.com/projects/396041877831350273" target="_blank" rel="noopener noreferrer" className="demo-btn">Live Simulation & Code</a>
                </div>
            </div>
